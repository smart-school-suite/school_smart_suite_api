...
class TeacherRequestedTimeSlotSolutionHandler implements SolutionPath
{
    public function supports(string $targetType): bool
    {
        return $targetType === TeacherRequestedTimeSlotBlocker::KEY || $targetType === TeacherRequestedTimeSlotConstraint::KEY;
    }

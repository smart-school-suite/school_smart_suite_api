...
namespace App\Schedular\SemesterTimetable\Suggestion\Solution\Handlers\Assignment;
...
class RequiredAssignmentSolutionHandler implements SolutionPath
{
    protected $conflict = "conflict";
    protected $dependency = "dependency";
    public function supports(string $targetType): bool
    {
        return $targetType === RequestedAssignmentConstraint::KEY || $targetType === RequestedAssigmentBlocker::KEY;
    }

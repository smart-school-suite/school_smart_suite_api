...
class HallRequestedTimeSlotSolutionHandler implements SolutionPath
{
    public function supports(string $targetType): bool
    {
        return $targetType === HallRequestedTimeSlotConstraint::KEY || $targetType === HallRequestedTimeSlotBlocker::KEY;
    }

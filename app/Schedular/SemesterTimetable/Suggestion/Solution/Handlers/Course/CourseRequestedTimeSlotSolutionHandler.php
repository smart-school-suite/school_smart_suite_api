...
namespace App\Schedular\SemesterTimetable\Suggestion\Solution\Handlers\Course;
...
class CourseRequestedTimeSlotSolutionHandler implements SolutionPath
{
    public function supports(string $targetType): bool
    {
        return $targetType === CourseRequestedSlotConstraint::KEY || $targetType === CourseRequestedSlotBlocker::KEY;
    }

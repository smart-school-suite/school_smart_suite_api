...
namespace App\Schedular\SemesterTimetable\Suggestion\Normalization\Resolvers\Teacher;
...
class TeacherRequestedSlotResolver extends SuggestionContext implements ResolverContract
{
    ...
    {
        return $type === TeacherRequestedTimeSlotBlocker::KEY || TeacherRequestedTimeSlotConstraint::KEY;
    }

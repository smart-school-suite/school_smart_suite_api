...
namespace App\Schedular\SemesterTimetable\Suggestion\Normalization\Resolvers\Course;
...
class CourseRequestedSlotResolver extends SuggestionContext implements ResolverContract
{
    ...
    {
        return $type === CourseRequestedSlotBlocker::KEY || $type === CourseRequestedSlotConstraint::KEY;
    }

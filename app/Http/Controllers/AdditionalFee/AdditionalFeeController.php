...
class AdditionalFeeController extends Controller
{
    ...
    public function createStudentAdditionalFees(CreateAdditionalFeeRequest $request)
    {
        ...
        $createAdditionalFees = $this->additionalFeeService->createStudentAdditionalFees($request->validated(), $currentSchool);
    ...
    {
        $currentSchool = $request->attributes->get('currentSchool');
        $updateAdditionalFees = $this->additionalFeeService->updateStudentAdditionalFees($request->validated(), $feeId, $currentSchool);
    ...
    {
        $currentSchool = $request->attributes->get('currentSchool');
        $deleteAdditionalFees = $this->additionalFeeService->deleteStudentAdditionalFees($feeId, $currentSchool);
    ...
    public function bulkBillStudents(BulkBillStudentAdditionalFeeRequest $request)
    {
        try {
            $currentSchool = $request->attributes->get('currentSchool');
            $bulkBillStudents = $this->additionalFeeService->bulkBillStudents($request->fee_details, $currentSchool);
    ...
    {
        try {
            $bulkDeleteAdditionalFees = $this->additionalFeeService->bulkDeleteStudentAdditionalFees($request->feeIds);
    ...
    public function bulkUpdateAdditionalFee(BulkUpdateAdditionalFeeRequest $request)
    {
        try {
            $currentSchool = $request->attributes->get('currentSchool');
            $this->additionalFeeService->bulkUpdateStudentAdditionalFees($request->additional_fee, $currentSchool);
    ...
    public function getStudentAdditionalFees(Request $request, $status)
    {
        ...
        $studentAdditionalFees = $this->additionalFeeService->getStudentAdditionalFees($currentSchool, $authStudent, $status);

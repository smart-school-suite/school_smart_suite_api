...
class instructoravailabilityController extends Controller
{
    ...
    if ($clashExists) {
        return response()->json(['error' => 'Time slot clash with existing timetable entries'], 409);
    }

        $new_availability_instance->save();

        return response()->json(['message' => 'instructor availability created succesfully'], 200);
    ...
    public function delete_teacher_avialability(Request $request, $availabilty_id){
        ...
        return response()->json(['message' => 'Teachers availability deleted succefully'], 200);
    }
    ...
    if ($clashExists) {
        ...
        return response()->json(['message' => 'Availability updated succesfully'], 200);
    }

...
use Carbon\Carbon;
class StudentAdditionalFeeReminderNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('### 💰 Fee Details')
            ->line('**Reason:** ' . $reason)
            ->line("Amount Due: Rwf {$notifiable->formatAmount($this->additionalFeeData['amount'])}")
    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'title' => "Fee Due Soon: Rwf {$notifiable->formatAmount($this->additionalFeeData['amount'])}",
    ...
    public function toBroadcast($notifiable): BroadcastMessage
    {
        ...
        return new BroadcastMessage([
            ...
            'body' => "Rwf {$notifiable->formatAmount($notifiable->formatAmount($this->additionalFeeData['amount']))} due for '{$this->additionalFeeData['reason']}' on {$dueDate}. Tap to pay.",

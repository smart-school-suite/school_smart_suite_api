...
class MaxDailyPeriodInterpreter implements ConstraintInterpreter
{
    ...
    {
        return $constraint === 'schedule_max_periods_per_day';
    }
    ...
    public function interpret(array $diagnostic): InterpretedDiagnostic
    {
        return new InterpretedDiagnostic(
            ...
            constraint: 'schedule_max_periods_per_day',
            severity: 'soft',
    ...
    private function buildSummary(array $diagnostic): string
    {
        ...
        return "
         The Schedular was unable to follow the maximum daily period limit on {$details['day']}. The reasons why

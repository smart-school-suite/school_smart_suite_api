...
class TeacherMaxWeeklyHourInterpreter implements ConstraintInterpreter
{
    ...
    {
        return $constraint === 'teacher_max_weekly_hours';
    }
    ...
    public function interpret(array $diagnostic): InterpretedDiagnostic
    {
        return new InterpretedDiagnostic(
            ...
            constraint: 'teacher_max_weekly_hours',
            severity: 'soft',
    ...
    private function buildSummary(array $diagnostic): string
    {
        ...
        return "
       The Schedular was unable to enforce the maximum weekly hour limit of {$details['max_hours']}
       for teacher {$teacherName}. The reasons why this happened are listed below";
    }
}

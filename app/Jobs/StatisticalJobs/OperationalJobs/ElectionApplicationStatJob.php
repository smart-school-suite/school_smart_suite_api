...
class ElectionApplicationStatJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $applicationDetails = ElectionApplication::where("school_branch_id", $this->schoolBranchId)->find($this->applicationId);
         $totalApplicationCountKpi = $kpis->get("total_application_count");
        if ($applicationDetails && $totalApplicationCountKpi) {
            $this->upsertElectionApplicationStat(
                $this->schoolBranchId,
                $totalApplicationCountKpi,
                null,
                null,
                $year
            );

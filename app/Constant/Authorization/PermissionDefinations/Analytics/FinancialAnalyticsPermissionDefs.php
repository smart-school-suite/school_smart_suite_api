...
use App\Constant\Authorization\Permissions\Analytics\FinancialAnalyticsPermissions;

class FinancialAnalyticsPermissionDefs
{
    public static function all(): array
    {
        return [
            PermissionBuilder::make(
                ...
                Guards::SCHOOL_ADMIN,
                FinancialAnalyticsPermissions::VIEW,
                "View",
                ""
            ),

...
namespace App\Constant\Violation\ExamTimetable\Hall;

class HallRequestedSlot
{
    public const KEY = "hall_requested_slot_violation";
    public const TITLE = "Hall Requested Slot Violation";

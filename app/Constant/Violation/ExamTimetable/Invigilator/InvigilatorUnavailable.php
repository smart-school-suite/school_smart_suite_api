...
namespace App\Constant\Violation\ExamTimetable\Invigilator;

class InvigilatorUnavailable
{
    public const KEY = "invigilator_unavailable";
    public const TITLE = "Invigilator Unavailable";

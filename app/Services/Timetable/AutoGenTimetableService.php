...
use App\Services\Timetable\TimetablePreprocessorService;

class AutoGenTimetableService
{
    protected TimetablePreprocessorService $autoGenTimetablePreprocessorService;

    public function __construct(TimetablePreprocessorService $autoGenTimetablePreprocessorService)
    {

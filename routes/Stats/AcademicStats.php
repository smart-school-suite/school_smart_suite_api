...
Route::get("/card-stats", [AcademicStatController::class, "getCardStats"])->name("academic.card.stats");
...
Route::get("/exam-type/fail-rate/{year}", [AcademicStatController::class, "getExamTypePassRate"])->name("exam.type.fail.rate");
Route::get("/level/fail-rate/{year}", [AcademicStatController::class, "getLevelPassRate"])->name("level.fail.rate");
